...
<!-- To add a publication: copy a whole "pub-item" block below and edit it.
     Thumbnail: put an image (or gif) in images/papers/ and update both href and src.
     Badge: use class="badge" for normal venues and class="badge-highlight" for
...
<!-- Uncomment when you have talks (also uncomment the Talks item in _includes/author-profile.html)
<h2 id="talks">Invited Talks</h2>

- [Venue Name](https://example.com), Mon. Year
